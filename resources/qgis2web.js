...
map.getView().fit([17342374.572693, -1183832.685190, 18220355.593023, -719069.986008], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Solomon Islands Wards</h2>';
        return titleElement;
    })(),
